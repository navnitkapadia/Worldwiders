              ...
              <div  class="row">
                <div class="col-md-5">
                  ...
                  <ul class="nav nav-tabs contact-list scrollbar-wrapper scrollbar-outer">
                    ...
                    <li>
                      <a href="newsfeed-messages.php#contact-3" data-toggle="tab">
                        <div class="contact">
                    ...
                    <li>
                      <a href="newsfeed-messages.php#contact-4" data-toggle="tab">
                        <div class="contact">
                    ...
                    <li>
                      <a href="newsfeed-messages.php#contact-5" data-toggle="tab">
                        <div class="contact">
                    ...
                    <li>
                      <a href="newsfeed-messages.php#contact-6" data-toggle="tab">
                        <div class="contact">
