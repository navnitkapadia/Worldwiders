                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <div class="friend-card">
                                                <img style="width:330px;height:138px;" src=<?php if($file){ echo "upload/$file"; } else {echo 'images/covers/5.jpg'; } ?> alt="profile-cover" class="img-responsive cover" />
                                                <div class="card-info">
                                                    <div class="friend-info">
                                                        ...
                                                        ?> 
                          <h5><a href="groups-detail.php" class="profile-link"><?php echo $title; ?></a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
